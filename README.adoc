...
:experimental:
:url-github: https://github.com/hyperpolymath/file-soup
:url-gitlab: https://gitlab.com/hyperpolymath/file-soup
:url-bitbucket: https://bitbucket.org/hyperpolymath/file-soup
:url-codeberg: https://codeberg.org/hyperpolymath/file-soup

Multi-format file parsing and conversion library
...
file-soup is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
